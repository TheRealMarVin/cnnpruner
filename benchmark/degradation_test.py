...
def display_graphs(current_score, all_scores):
    plt.title("Display degradatrion")
    # plt.xlabel(xlabel)
    plt.ylabel("Pruning Percent")
    display_graphs(current_score, all_scores)
