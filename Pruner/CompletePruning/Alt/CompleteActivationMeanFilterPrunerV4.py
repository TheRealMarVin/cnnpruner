...
"""
class ActivationMeanFilterPrunerV4(CompleteFilterPruner):

    def __init__(self, model, sample_run, force_forward_view=False, ignore_last_conv=False):
        super(ActivationMeanFilterPrunerV4, self).__init__(model, sample_run, force_forward_view, ignore_last_conv)
        self.merged_results = {}
        # self.reasign_nodes = {}
        self.sets = []
        self.ignore_list = []
